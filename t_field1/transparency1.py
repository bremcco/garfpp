...
directory = '/afs/cern.ch/user/b/bmcconne/private/garfieldpp/t_field1/500/gem1_extract'


# Load the field map.
fm = ROOT.Garfield.ComponentAnsys123()
fm.Initialise("500/ELIST.lis", "500/NLIST.lis", "500/MPLIST.lis", "500/PRNSOL.lis", "micron")
