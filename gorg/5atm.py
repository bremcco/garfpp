...
pressure = 760. * 10.0
file_name = '10atm.csv'
directory = '/afs/cern.ch/user/b/bmcconne/private/garfieldpp/gorg/new_config'


# Load the field map.
fm = ROOT.Garfield.ComponentAnsys123()
fm.Initialise("new_config/ELIST.lis", "new_config/NLIST.lis", "new_config/MPLIST.lis", "new_config/PRNSOL.lis", "micron")
