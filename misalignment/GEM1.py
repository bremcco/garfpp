...
def write_csv(data, directory, filename):
    ...
    with open(file_path, mode='w', newline='') as csvfile:
        ...
        # header
        writer.writerow(["trial", "x", "y", "z", "dx", "dy", "dz", "energy"])
...
trials = 10
pressure = 760.
file_name = 'GEM1_output_arch4955.csv'
...
# Setup the gas.
gas = ROOT.Garfield.MediumMagboltz("ar", 95., "ch4", 5.)
...
sensor.SetArea(-2, -1, -0.3, 2,  1, 1.8)
