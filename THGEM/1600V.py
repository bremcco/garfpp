...
file_name = '1600V.csv'
directory = '/afs/cern.ch/user/b/bmcconne/private/garfieldpp/THGEM/benchmark'
...
fm.Initialise("benchmark/1600/ELIST.lis", "benchmark/1600/NLIST.lis", "benchmark/1600/MPLIST.lis", "benchmark/1600/PRNSOL.lis", "mm")
...
fieldView.SetArea(-0.5 * pitch, -0.1, 0.5 * pitch, 0.1)
fieldView.SetVoltageRange(-750., 900.)
fieldView.GetCanvas().SetLeftMargin(0.16)
fieldView.PlotContour()
cF.SaveAs('field_map.png')
...
if plotDrift:
  if plotMesh:
    meshView.SetArea(-2 * pitch, -0.2, 2 * pitch, 0.5)
