...
pressure = 760. * 2
file_name = '2atm.csv'
directory = '/afs/cern.ch/user/b/bmcconne/private/garfieldpp/thgem/3832'


# Load the field map.
fm = ROOT.Garfield.ComponentAnsys123()
fm.Initialise("thgem/3832/ELIST.lis", "thgem/3832/NLIST.lis", "thgem/3832/MPLIST.lis", "thgem/3832/PRNSOL.lis", "mm")
