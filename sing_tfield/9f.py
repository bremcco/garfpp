...
pressure = 760. * 6.0
file_name = '6atm.csv'
directory = '/afs/cern.ch/user/b/bmcconne/private/garfieldpp/sing_tfield/ext_tfield/9kVcm'


# Load the field map.
fm = ROOT.Garfield.ComponentAnsys123()
fm.Initialise("ext_tfield/9kVcm/ELIST.lis", "ext_tfield/9kVcm/NLIST.lis", "ext_tfield/9kVcm/MPLIST.lis", "ext_tfield/9kVcm/PRNSOL.lis", "mm")
...
for i in range(trials):
  ...
  ne_list.append(n_final/n_primary)
