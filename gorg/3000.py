...
trials = 1
pressure = 760. * 1
file_name = '3000V_redo.csv'
directory = '/afs/cern.ch/user/b/bmcconne/private/garfieldpp/gorg/3000_redo'


# Load the field map.
fm = ROOT.Garfield.ComponentAnsys123()
fm.Initialise("3000_redo/ELIST.lis", "3000_redo/NLIST.lis", "3000_redo/MPLIST.lis", "3000_redo/PRNSOL.lis", "micron")
