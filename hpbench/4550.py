...
trials = 1
pressure = 760. * 3.0
file_name = '3_4550.csv'
directory = '/afs/cern.ch/user/b/bmcconne/private/garfieldpp/hpbench/4550'


# Load the field map.
fm = ROOT.Garfield.ComponentAnsys123()
fm.Initialise("hpbench/4550/ELIST.lis", "hpbench/4550/NLIST.lis", "hpbench/4550/MPLIST.lis", "hpbench/4550/PRNSOL.lis", "micron")
