...
directory = '/afs/cern.ch/user/b/bmcconne/private/garfieldpp/t_field1/3000/gem1_extract'


# Load the field map.
fm = ROOT.Garfield.ComponentAnsys123()
fm.Initialise("3000/ELIST.lis", "3000/NLIST.lis", "3000/MPLIST.lis", "3000/PRNSOL.lis", "micron")
