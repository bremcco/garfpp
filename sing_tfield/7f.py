...
pressure = 760. * 4.0
file_name = '4atm.csv'
directory = '/afs/cern.ch/user/b/bmcconne/private/garfieldpp/sing_tfield/ext_tfield/7kVcm'


# Load the field map.
fm = ROOT.Garfield.ComponentAnsys123()
fm.Initialise("ext_tfield/7kVcm/ELIST.lis", "ext_tfield/7kVcm/NLIST.lis", "ext_tfield/7kVcm/MPLIST.lis", "ext_tfield/7kVcm/PRNSOL.lis", "mm")
