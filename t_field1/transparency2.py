...
trials = 20
pressure = 760. * 4.0
file_name = '4_0atm.csv'
directory = '/afs/cern.ch/user/b/bmcconne/private/garfieldpp/t_field1/9000/gem2_input/'


# Load the field map.
fm = ROOT.Garfield.ComponentAnsys123()
fm.Initialise("9000/ELIST.lis", "9000/NLIST.lis", "9000/MPLIST.lis", "9000/PRNSOL.lis", "micron")
...
sensor.SetArea(-2, -1, -2, 2,  1, 0.0055)
...
for i in range(trials):
  ...
  transported.append(N_after)
  
if len(transported) > 0:
    avg_transported = sum(transported) / len(transported)
else:
    avg_transported = 0.0

write_csv([avg_transported], directory, file_name)
...
if plotDrift:
  if plotMesh:
    meshView.SetArea(-2 * pitch, -0.1, 2 * pitch, 0.1)
