...
pressure = 760. * 6.0
file_name = '6atm.csv'
directory = '/afs/cern.ch/user/b/bmcconne/private/garfieldpp/sing_tfield/ext_tfield/5kVcm'


# Load the field map.
fm = ROOT.Garfield.ComponentAnsys123()
fm.Initialise("ext_tfield/5kVcm/ELIST.lis", "ext_tfield/5kVcm/NLIST.lis", "ext_tfield/5kVcm/MPLIST.lis", "ext_tfield/5kVcm/PRNSOL.lis", "mm")
