...
trials = 1
pressure = 760. * 3.0
file_name = '3_4450.csv'
directory = '/afs/cern.ch/user/b/bmcconne/private/garfieldpp/hpbench/4450'


# Load the field map.
fm = ROOT.Garfield.ComponentAnsys123()
fm.Initialise("hpbench/4450/ELIST.lis", "hpbench/4450/NLIST.lis", "hpbench/4450/MPLIST.lis", "hpbench/4450/PRNSOL.lis", "micron")
