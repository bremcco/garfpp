...
trials = 1
pressure = 760. * 1.0
file_name = 'arco29010.csv'
directory = '/afs/cern.ch/user/b/bmcconne/private/garfieldpp/gorg/3150_test'


# Load the field map.
fm = ROOT.Garfield.ComponentAnsys123()
fm.Initialise("3150/ELIST.lis", "3150/NLIST.lis", "3150/MPLIST.lis", "3150/PRNSOL.lis", "micron")
...
'''
# Setup the gas.
gas = ROOT.Garfield.MediumMagboltz("ar", 80., "co2", 10.)
