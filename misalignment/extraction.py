...
directory = '/afs/cern.ch/user/b/bmcconne/private/garfieldpp/misalignment/0_misalignment/GEM1'


# Load the field map.
fm = ROOT.Garfield.ComponentAnsys123()
fm.Initialise("0_misalignment/GEM1/ELIST.lis", "0_misalignment/GEM1/NLIST.lis", "0_misalignment/GEM1/MPLIST.lis", "0_misalignment/GEM1/PRNSOL.lis", "mm")
...
fieldView.SetArea(-0.5, -0.02, 0.5, 0.02)
...
sensor.SetArea(-2, -1, -0.21, 2,  1, 0.5)
...
if plotDrift:
  if plotMesh:
    meshView.SetArea(-2 * pitch, -0.2, 2 * pitch, 0.2)
