...
pressure = 760. * 1
file_name = '500V.csv'
directory = '/afs/cern.ch/user/b/bmcconne/private/garfieldpp/correia_benchmark'


# Load the field map.
fm = ROOT.Garfield.ComponentAnsys123()
fm.Initialise("500V/ELIST.lis", "500V/NLIST.lis", "500V/MPLIST.lis", "500V/PRNSOL.lis", "mm")
...
fieldView.SetVoltageRange(-500., 500.)
...
gas.LoadIonMobility('/afs/cern.ch/user/b/bmcconne/private/garfieldpp/Data/IonMobility_Ar+_Ar.txt')
...
sensor.SetArea(-2, -1, -0.1, 2,  1, 0.1)
