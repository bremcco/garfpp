...
trials = 1
pressure = 760. * 6.0
file_name = '6_0atm.csv'
directory = '/afs/cern.ch/user/b/bmcconne/private/garfieldpp/t_field1/5000/gem1_extract'


# Load the field map.
fm = ROOT.Garfield.ComponentAnsys123()
fm.Initialise("5000/ELIST.lis", "5000/NLIST.lis", "5000/MPLIST.lis", "5000/PRNSOL.lis", "micron")
...
for i in range(trials):
  ...
  ratio_transported.append(N_after/N_before)

write_csv(ratio_transported,directory, file_name)
'''
