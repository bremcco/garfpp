...
trials = 1
pressure = 760. * 3.0
file_name = '3_4250.csv'
directory = '/afs/cern.ch/user/b/bmcconne/private/garfieldpp/hpbench/new_4250'


# Load the field map.
fm = ROOT.Garfield.ComponentAnsys123()
fm.Initialise("hpbench/new_4250/ELIST.lis", "hpbench/new_4250/NLIST.lis", "hpbench/new_4250/MPLIST.lis", "hpbench/new_4250/PRNSOL.lis", "micron")
