...
pressure = 760. * 6
file_name = '6kVcm.csv'
directory = '/afs/cern.ch/user/b/bmcconne/private/garfieldpp/colleff/6atm'


# Load the field map.
fm = ROOT.Garfield.ComponentAnsys123()
fm.Initialise("6/ELIST.lis", "6/NLIST.lis", "6/MPLIST.lis", "6/PRNSOL.lis", "mm")
