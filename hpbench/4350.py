...
trials = 100
pressure = 760. * 3.0
file_name = '3_4350.csv'
directory = '/afs/cern.ch/user/b/bmcconne/private/garfieldpp/hpbench/4350'


# Load the field map.
fm = ROOT.Garfield.ComponentAnsys123()
fm.Initialise("hpbench/4350/ELIST.lis", "hpbench/4350/NLIST.lis", "hpbench/4350/MPLIST.lis", "hpbench/4350/PRNSOL.lis", "micron")
